...
unsigned char emergencyChar;
unsigned char calculateOrientationChar;
MotorSpeeds motorSpeedsPtr;
int cnt10;   //detectEmergency
int cnt100;  //refreshSensorData
int cnt1000; //for green led calculateOrientation,updatePid
int cnt2000; //for red led
...
void manualSchedule(void){
	//this is executed 10ms each time with highest priority	
	emergencyChar =  detectEmergency(); 
	

	calculateOrientationChar = calculateOrientationChar = calculateOrientation(); 
